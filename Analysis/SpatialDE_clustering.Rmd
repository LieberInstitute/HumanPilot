...
for (i in seq_along(pages)) {
    ...
    file1 <- paste0("../plots/SpatialDE_clustering/clustering_unsupervised_", sample_names[pages[[i]][1]], ".png")
    file2 <- paste0("../plots/SpatialDE_clustering/clustering_semisupervised_", sample_names[pages[[i]][1]], ".png")
    file3 <- paste0("../plots/SpatialDE_clustering/clustering_unsupervised_", sample_names[pages[[i]][2]], ".png")
    file4 <- paste0("../plots/SpatialDE_clustering/clustering_semisupervised_", sample_names[pages[[i]][2]], ".png")
...
file_out <- paste0("../plots/supp_figures/supp_clustering_page_0.pdf")

...
#system("cp ../plots/SpatialDE_genes_analysis/upset_genes_combined.pdf ../plots/figure/fig_LMW_gene_lists_intersection.pdf")
```


```{r, fig.width = 6.75, fig.height = 2.75}
# select gene(s)
genes_fig <- c("PCP4", "HBB", "IGKC")
...
filename <- paste0("../plots/figure/fig_LMW_expression_selected.pdf")
ggsave(filename, width = 6.75, height = 2.75)
```
